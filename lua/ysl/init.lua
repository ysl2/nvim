    ...
    config = function()
      require('transparent').setup({
        ...
        extra_groups = { -- table/string: additional groups that should be cleared
          ...
          'lualine_x_filetype_DevIconTex_normal',
          'lualine_x_filetype_DevIconTex_insert',
          'lualine_x_filetype_DevIconTex_visual',
          'lualine_x_filetype_DevIconTex_replace',
          'lualine_x_filetype_DevIconTex_command',
          'lualine_x_filetype_DevIconTex_terminal',
          'lualine_x_filetype_DevIconTex_inactive',
