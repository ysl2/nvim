# ysl2/nvim: An ultimate neovim pure lua configuration focuses on KISS principle.
...
> 2. All things you need: language server, file tree, motion, bookmark, register, edit history, buffer & window control, terminal, git, session save and auto restore like vscode, colors & highlight & outlooks, motions, fuzzy find & global replace, remote ssh, markdown image paste and markdown preview
...
> 7. Intregration with others: VSCode's neovim extension support, Chrome support.
